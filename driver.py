from load_data import train_data, train_label, test_data, test_label, validation_data, validation_label, positive_train, negative_train
...
learning_rate = 1e-3
iterations = 30
methods = ['original_data', 'dca', 'pca', 'clr', 'ilr', 'coda', 'coda_ae' ]
...
for i in range(iterations):
    ...
    for k in k_values:
        for sample_size in range( 20, 200, 20 ):
    ...
    with open('marshwren/tuned_data' + str(i) + '.pickle', 'wb') as handle:
